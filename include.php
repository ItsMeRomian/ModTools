...
if (strpos($_SERVER["REQUEST_URI"], ".php") !== false) {
	...
	header("Location: https://" . $_SERVER["SERVER_NAME"] . "" . $stripped);
}
...
<link rel="icon" href="https://hotel.dyna.host/templates/DynaHotel/images/icons/senha.gif" type="image/x-icon" />
...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top" >
  <a class="navbar-brand" href="home.php"><img style="width: 100px;" src="https://hotel.dyna.host/templates/DynaHotel/images/logo2.webp"> MODTOOLS</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	...
	<div class="navbar-nav ml-auto" style="color: white;">
		<a class="nav-item nav-link btn btn-success" style="color: white; margin-right: 5px;"target="_BLANK"href="https://hotel.dyna.host/client">CLIENT (new tab) »</a>
