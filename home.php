	...
	<div class="row">
		<div class="col">
			...
			<div class="alert alert-danger fade show" role="alert">
				...
				$server = runarray("SELECT * FROM server_status");
				if ($server['users_online'] == 1) { ?>
			...
			<div class="alert alert-info fade show" role="alert">
				...
				<?= $modtools["welcome"] ?><br>
				You're logged in with, <b><?= $_SESSION['username'] ?></b>, ip <b><?= $_SERVER['REMOTE_ADDR'] ?></b>, And have rank <b><?= $_SESSION['rank'] ?></b> (that's <b><?= $_SESSION['rankname'] ?></b>)
			</div>
		</div>
	</div>
	<div class="row">
