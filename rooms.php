...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-2">
			...
			<img style="width: 120px;" src="/img_rooms/<?= $room->get('model_name') ?>.png">
		</div>
		<div class="col">
			<table class="table table-sm">
				...
				<tr>
					...
					<td><?= $room->get('users_now') ?></td>
				</tr>
				<tr>
					<td><b>MODEL:</b></td>
					<td><?= $room->get('model_name') ?></td>
				</tr>
				<tr>
					<td><b>STATUS:</b></td>
					<td><?= $room->get('state') ?></td>
				</tr>
				<tr>
					<td><b>GUILD:</b></td>
					<td><a href="guilds.php?id=<?= $room->get('group_id') ?>"><?= $room->get('group_id') ?> (go)</a></td>
				</tr>
			</table>
		</div>
		<div class="col">
	...
	<div class="row">
		<div class="col">
			...
			<table style="width: 100%;" class="table table-striped">
				...
				<?php }
				if (runassoc("SELECT * FROM chatlogs WHERE room_id = " . $room->get('id') . " ORDER BY timestamp DESC LIMIT 50") == 0) { ?>
					<tr>
						<td>no chat!</td>
					</tr>
				<?php } ?>
